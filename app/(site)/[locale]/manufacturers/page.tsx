...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    title: locale === "fr" ? "Fabricants" : "Manufacturers",
    description:
      locale === "fr"
        ? "Fondation de l'index fabricants ATA."
        : "Manufacturer index foundation for the ATA public catalog.",
    pathname: `/${locale}/manufacturers`,
  });
}

export default async function ManufacturersIndexPage() {
  const page = await getTranslations("pages.manufacturers");
